...
**Registration Number:** 25BCE10371           
**Branch & Year:** B.Tech CSE (Core), 1st Year

---

## Project Overview
As a **Student Digital Ambassador**, I have developed this portfolio to help my peers navigate the digital world safely and professionally.
This repository contains five distinct tasks mapping to the core modules of this course.
...
**Quiz Link:** https://forms.gle/cHubtexGNxnSc5S9A   
...
* `task-1-presentation/`: Infographic and tool descriptions.
* `task-2-portfolio/`: Professional profile screenshots.
* `task-3-platforms/`: Coding challenge proof and Google Form screenshots.
...
## Contact & Links
**GitHub Profile:** https://github.com/suryansh-2007   
